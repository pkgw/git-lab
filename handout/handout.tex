...
The \x repository we cloned is named \s{bloomdemo}. Let's learn a bit more about
it:
...
\xnote{Newer versions of \git\ suggest that you use \cmd{restore} instead of
  \cmd{checkout} here. The new name was created because \cmd{checkout} did two
  very different jobs, as we'll see later. But not that many computers have a
  new enough version of \git\ installed just yet.}
...
\xnote{This is an \i{enormously} important aspect of \git\ --- it makes it
  ...
  happened between different commits.}
