...
\s{main}, \i{and} it's synchronized your working tree to match
\s{print-my-name}.
...
\s{print-my-name}, that's the one that will be updated, not \s{main}.
...
\xnote{Recall that \s{main} contains your change to print the correct Bloom
...
another. Here we'll merge your \s{print-my-name} branch into your \s{main}
branch.
...
\s{main} branch, you can tidy things up by deleting it:
...
\href{https://stackexchange.com/}{StackExchange.com} family of websites is
