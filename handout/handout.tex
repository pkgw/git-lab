...
of ``\t{<<<<}'', the changes from one branch, then ``\t{====}'', the changes
...
fiction. Fundamentally, any commit, whether it's a merge commit or not, is an
assertion by a human that what follows bears some useful relation to what came
before.
