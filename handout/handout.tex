...
\cmd{merge}, though it has a few bells and whistles. Generally speaking, if
you want to update your repository, you want to run \cmd{status} (to check
whether you have an uncommitted changes that need to be tidied up) then
\cmd{pull}.

\typeone{git pull origin master}{\b{Fetch and merge nonexistent updates, again.}}
