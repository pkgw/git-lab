...
\git\ should highlight that \t{indict} has been modified. It should also tell
you how to discard your changes if you decide you don't like them:

\begin{typeme}
git checkout indict & Discard changes to indict. \\
./indict barn bern birn born burn & Check that change is gone. \\
git status & Check modification status.
\end{typeme}
